...
export default function ContactPageClient({ params }: Props) {
  ...
  const contactContent = {
    tr: {
      ...
      address: "Adres",
      addressLine1: "İnişdibi Cd. No:54, 48650 Akyaka, Ula/Muğla, Türkiye",
      addressLine2: "Azmak Nehri kıyısında, eşsiz doğa manzarası eşliğinde",
    ...
    en: {
      ...
      address: "Address",
      addressLine1: "İnişdibi Cd. No:54, 48650 Akyaka, Ula/Muğla, Turkey",
      addressLine2: "On the banks of Azmak River, with stunning natural views",
    ...
    de: {
      ...
      address: "Adresse",
      addressLine1: "İnişdibi Cd. No:54, 48650 Akyaka, Ula/Muğla, Türkei",
